...
const COLLECTIONS = {
  ...
  USER_ROLES: 'user_roles',  // 用户角色关联表（支持多角色、角色过期）
  USER_BATCH_ASSIGNMENTS: 'user_batch_assignments',  // 用户批次分配表
  USER_SESSIONS: 'user_sessions',  // 用户会话管理表
...
const COLLECTION_MODULES = {
  USER_MANAGEMENT: [
    ...
    COLLECTIONS.USER_BATCH_ASSIGNMENTS,
