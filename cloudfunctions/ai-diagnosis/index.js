...
第二步：症状系统分析
→ 神经系统：扭颈、转圈、瘫痪、角弓反张 → 副粘病毒、里默氏杆菌、VE缺乏
→ 消化系统：粪便性状（水样/血样/糊状）→ 小鹅瘟、球虫、大肠杆菌
→ 呼吸系统：张口呼吸、流涕 → 曲霉菌、大肠杆菌气囊炎
→ 运动系统：跛行、关节肿胀 → 维生素缺乏、关节炎、痛风
