...
let pendingAllBatchesPromise: Promise<BaseResponse> | null = null
let latestAllBatchesSnapshot: unknown = null
...
export function buildHealthStatsUpdate(healthData: unknown, preventionStats: unknown, options: {
  vaccinationRate: number
  batchesWithPrevention: Batch[]
  diagnosisHistory?: Batch[]
  abnormalList?: Batch[]}) {
