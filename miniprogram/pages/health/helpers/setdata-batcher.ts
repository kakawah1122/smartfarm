...
export class SetDataBatcher {
  ...
  constructor(page: any, delay: number = 16) { // 默认一帧时间
    this.page = page
    this.delay = delay
  }
 ...
 */
export function createSetDataBatcher(page: any, delay?: number): SetDataBatcher {
...
export class DataDiffer {
   ...
   * @returns 差异对象
   */
  static diff(oldData: any, newData: any, prefix: string = ''): BatchUpdate {
   ...
   */
  static applyDiff(page: any, oldData: any, newData: any, batcher?: SetDataBatcher): void {
